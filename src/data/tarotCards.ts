...
export const tarotCards: TarotCard[] = [
    // Major Arcana (0-21)
    { id: 0, name: "Fool-Child", image: "/images/cards/major_00.webp", message: "恐れを手放し、未知の世界へ飛び込みましょう。子供のような純粋な好奇心が、あなたを新しい冒険へと導きます。過去の常識にとらわれず、今この瞬間を楽しみましょう。すべての可能性は、あなたの手の中にあります。", category: "Major" },
    ...
    { id: 2, name: "High Priestess", image: "/images/cards/major_02.webp", message: "静寂の中で、内なる声に耳を傾けてください。答えは外側の世界ではなく、あなたの深い直感の中にあります。知識ではなく、感覚を信頼しましょう。神秘のヴェールを開き、真実を見出す時です。", category: "Major" },
    ...
    { id: 15, name: "Devil", image: "/images/cards/major_15.webp", message: "あなたを縛り付けているのは、他でもない自分自身の恐れや執着です。制限や思い込みの鎖を断ち切り、自由になりましょう。本能や欲望を否定せず、笑い飛ばすユーモアを持つことで、あなたは解放されます。", category: "Major" },
    ...
    // Crystals (22-35)
    { id: 22, name: "Ace of Crystals (Wholeness)", image: "/images/cards/crystals_01.webp", message: "あなたは完全な存在です。心、体、精神が統合され、一つになる感覚を思い出してください。欠けているものは何もありません。その完全性を信じて行動しましょう。", category: "Crystal" },
    ...
    { id: 30, name: "Nine of Crystals (Cruelty)", image: "/images/cards/crystals_09.webp", message: "自分や他者に厳しくしすぎていませんか？ 鋭い言葉や批判は、時に刃となります。知性は優しさと共に使ってこそ、真の力を発揮することを忘れないでください。", category: "Crystal" },
    ...
    // Cups (36-49)
    { id: 36, name: "Ace of Cups (Esctasy)", image: "/images/cards/cups_01.webp", message: "至福の喜びに浸りましょう。理屈を超えた感情の波が押し寄せています。愛すること、生きることの喜びを全身で感じ、魂を震わせてください。", category: "Cup" },
    { id: 37, name: "Two of Cups (Equilibrium)", image: "/images/cards/cups_02.webp", message: "心の均衡を保ちましょう。感情の起伏に飲み込まれることなく、静かな湖面のような穏やかさを大切にしてください。中心軸を保つことで、平和が訪れます。", category: "Cup" },
    { id: 38, name: "Three of Cups (Rejoice)", image: "/images/cards/cups_03.webp", message: "喜びを分かち合いましょう。友人や家族と共に祝い、笑い合うことで、幸せは倍増します。祝祭のエネルギーが、あなたの心を明るく満たしてくれるでしょう。", category: "Cup" },
    ...
    // Worlds (50-63)
    { id: 50, name: "Ace of Worlds (Reward)", image: "/images/cards/worlds_01.webp", message: "報酬を受け取る時です。あなたのこれまでの努力が形となり、結果として表れています。遠慮することなく、物質的な豊かさや成功を感謝して受け取りましょう。", category: "World" },
    { id: 51, name: "Two of Worlds (Change)", image: "/images/cards/worlds_02.webp", message: "変化の波に乗りましょう。変わり続けることこそが、安定への唯一の道です。柔軟に対応し、状況に合わせて形を変えることで、どんな環境でも繁栄できます。", category: "World" },
    { id: 52, name: "Three of Worlds (Work)", image: "/images/cards/worlds_03.webp", message: "仕事に打ち込みましょう。コツコツと積み上げる作業が、確実な成果を生み出します。働く喜びを見出し、自分の能力を社会のために役立ててください。", category: "World" },
    { id: 53, name: "Four of Worlds (Persistence)", image: "/images/cards/worlds_04.webp", message: "粘り強く続けましょう。すぐに結果が出なくても、あきらめないでください。雨だれが石を穿つように、あなたの継続的な努力が大きな山を動かします。", category: "World" },
    ...
    { id: 55, name: "Six of Worlds (Poverty)", image: "/images/cards/worlds_06.webp", message: "欠乏感を手放しましょう。「ない」ものに目を向けるのではなく、「ある」ものに感謝してください。心の豊かさが、物質的な豊かさを引き寄せる磁石となります。", category: "World" },
    { id: 56, name: "Seven of Worlds (Delay)", image: "/images/cards/worlds_07.webp", message: "焦らず待ちましょう。物事には最適なタイミングがあります。遅れは準備期間だと捉え、今は力を蓄え、計画を見直す時間に充ててください。", category: "World" },
    { id: 57, name: "Eight of Worlds (Interference)", image: "/images/cards/worlds_08.webp", message: "邪魔が入っても動揺しないでください。障害物は、あなたの決意を試すテストです。雑音をシャットアウトし、目標に向かって集中力を高めましょう。", category: "World" },
    ...
    { id: 59, name: "Ten of Worlds (Success)", image: "/images/cards/worlds_10.webp", message: "成功おめでとうございます！ 目標を達成し、頂点に立つ喜びを享受してください。しかし、ここはゴールであると同時に次のスタート地点でもあります。新たな高みを目指しましょう。", category: "World" },
    ...
    { id: 62, name: "Woman of Worlds (Preserver)", image: "/images/cards/worlds_13.webp", message: "大切なものを守り育てましょう。自然環境や身体、財産など、持続可能な豊かさを維持するためのケアをしてください。慈しむ心が、繁栄を長く続かせます。", category: "World" },
    ...
    { id: 70, name: "Seven of Wands (Virtue)", image: "/images/cards/wands_07.webp", message: "あなたの美徳と誠実さを大切にしてください。外側の評価に惑わされず、自分の信じる正しさを貫きましょう。内なる高潔さが、あなたを正しい方向へと導いてくれます。", category: "Wand" },
    { id: 71, name: "Eight of Wands (Growth)", image: "/images/cards/wands_08.webp", message: "成長の時です。学び続け、変化し続けることを楽しんでください。古い殻を破り、枝葉を広げるように、あなたの可能性は無限に拡大していきます。", category: "Wand" },
    { id: 72, name: "Nine of Wands (Integrity)", image: "/images/cards/wands_09.webp", message: "言行一致を目指しましょう。心で思っていることと、実際の行動を一致させることで、あなたの integrity (誠実さ・完全性) は高まります。自分に嘘をつかない生き方を貫いてください。", category: "Wand" },
    { id: 73, name: "Ten of Wands (Attunement)", image: "/images/cards/wands_10.webp", message: "周囲との調和を意識しましょう。独りよがりにならず、環境や他者のエネルギーと同調することで、より大きな流れに乗ることができます。バランスを取り、全体の一部として機能してください。", category: "Wand" },
    { id: 74, name: "Child of Wands (Player)", image: "/images/cards/wands_11.webp", message: "人生を遊び場のように楽しみましょう。深刻になりすぎず、ユーモアと遊び心を持って取り組むことで、創造的な解決策が見つかります。無邪気なエネルギーが突破口になります。", category: "Wand" },
    ...
    { id: 76, name: "Woman of Wands (Seer)", image: "/images/cards/wands_13.webp", message: "直感を研ぎ澄ましましょう。目に見える世界だけでなく、その背後にあるエネルギーを感じ取ってください。内なる眼で見通すことで、真実を捉えることができます。", category: "Wand" },
    { id: 77, name: "Sage of Wands (Curer)", image: "/images/cards/wands_14.webp", message: "癒しの力を行使しましょう。あなた自身の経験や知恵を使って、自分と他者を癒してください。古い傷を手放し、エネルギーを浄化することで、本来の健やかさが戻ります。", category: "Wand" },
];
